 ...
 * 
 * @export
 * @interface RequestBodyRules
 */
export interface RequestBodyRules {
    /**
     * 
     * @type {string}
     * @memberof RequestBodyRules
     */
    match?: RequestBodyRulesMatchEnum;
    /**
     * 
     * @type {Array<StringRule>}
     * @memberof RequestBodyRules
     */
...
* @enum {string}
*/
export enum RequestBodyRulesMatchEnum {
    ANY = 'ANY',
    ALL = 'ALL',
    ONLY = 'ONLY',
    NONE = 'NONE'
...
export function RequestBodyRulesFromJSON(json: any): RequestBodyRules {
    return RequestBodyRulesFromJSONTyped(json, false);
}

export function RequestBodyRulesFromJSONTyped(json: any, ignoreDiscriminator: boolean): RequestBodyRules {
    ...
    return {
        ...
        'rules': !exists(json, 'rules') ? undefined : ((json['rules'] as Array<any>).map(StringRuleFromJSON)),
    };
}

export function RequestBodyRulesToJSON(value?: RequestBodyRules | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'match': value.match,
        'rules': value.rules === undefined ? undefined : ((value.rules as Array<any>).map(StringRuleToJSON)),
    };
}
