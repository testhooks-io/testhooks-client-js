...
export function ResponseRuleFromJSON(json: any): ResponseRule {
    return ResponseRuleFromJSONTyped(json, false);
}

export function ResponseRuleFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResponseRule {
...
export function ResponseRuleToJSON(value?: ResponseRule | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
